...
\tytul{Malowane Łodzie Przyjemności z Yangzhou}\label{li_dou}\footnote{Tytułowe
,,łodzie przyjemności'' to domy publiczne w Yangzhou (扬州 \pinyin{Yángzhōu}), mieście we
...
% KULTURA POPULARNA
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Madżong w kulturze popularnej}
...
Już w 1796 roku w powieści \tytul{Malowane Łodzie Przyjemności z Yangzhou}
autorstwa Li Dou bohaterowie grają w prekursora madżonga, grę karcianą
\pinyin{shihu}, w domach publicznych (patrz: strona \pageref{li_dou}) (Stanwick
\& Xu).

Od lat dwudziestych XX wieku (patrz: sekcje \ref{shanghai20s} oraz \ref{cc}),
madżong zaczął występować w literaturze zachodniej. W powieści \tytul{Zabójstwo
Rogera Ackroyda} autorstwa Agathy Christie z 1926 roku, trzeciej części przygód
...
Madżong nie został zapomniany również w literaturze chińskiej -- w
powieści szpiegowskiej \tytul{Ostrożnie, pożądanie} (色，戒 \pinyin{Sè, Jiè})
autorstwa Eileen Chang (张爱玲 Zhāng Ailíng) jest stałym, często powtarzającym się
motywem (Chang 2007).

\tytul{The Joy Luck Club} to powieść z 1989 roku autorstwa Amy Tan. Opowiada o
...
\ref{AMJ} na stronie \pageref{AMJ}). %TODO

Terry Pratchett, znany brytyjski satyryk i pisarz fantasy, ukrył madżonga pod
nazwą \foreign{Shibo Yangcong-san}\footnote{\foreign{Shibo Yangcong-san} to
wyrażenie łączące słowa \pinyin{shipo} (使破 \pinyin{shǐpò}) i \pinyin{yangcong}
(洋葱 \pinyin{yángcōng}) z języka chińskiego (oznaczające odpowiednio ,,zepsuć'' i
''cebula'') oraz przyrostku honoryfikatywnego \romaji{-san} (さん) z języka
japońskiego. Po takiej interpretacji tej nazwy można otrzymać zapis
chińsko-japoński 使破洋葱さん (\pinyin{shǐpò} \pinyin{yángcōng-san}, który można
dosłownie przetłumaczyć jako ,,złamać pana cebulę''. Jest to nawiązanie do
innej fikcyjnej gry z książek T. Prattchetta - Okalecz Pana Cebulę, która jest
parodią gry w pokera.} w swojej powieści \tytul{Ciekawe Czasy} z 1994 roku.
...
słynnym agencie brytyjskiego wywiadu, Jamesie Bondzie -- \tytul{Zero Minus
Ten} z 1997 roku autorstwa Raymonda Bensona, główny bohater uprawia hazard w
...
adaptacje \tytul{The Joy Luck Club} z 1993 roku i \tytul{Ostrożnie, pożądanie} z
2007) (Wáng 1993; Li 2007).

W amerykańskim serialu \tytul{Carnivàle} z 2003 roku, który
...
W innej produkcji amerykańskiej -- \tytul{Lie to me}, serialu kryminalnym z 2009
...
hongkońska seria filmów komediowych \tytul{Kung Fu Mahjong} (雀聖 Zoek3sing3)
(której wydano 3 części, pierwsza pochodzi z 2005 roku) oraz \tytul{Mahjong
Dragon} (麻雀飛龍 Maa4zoek3 Fei1lung4) (film z 1997 roku, także z Hong Kongu)
(Wáng 2005; Liú 1996).

Pośród japońskich seriali \romaji{anime}\footnote{\romaji{Anime} (アニメ) --
japońska animacja.}, wiele pozycji także traktuje madżonga jako motyw przewodni.
Najpopularniejszym przykładem jest \tytul{,,Akagi: Geniusz, który zstąpił w
ciemność''} (アカギ闇に降り立った天才 \romaji{Akagi:} \romaji{Yami} \romaji{ni}
\romaji{Oritatta} \romaji{Tensai}) (więcej o komiksie, na podstawie którego
powstało to \romaji{anime} -- patrz: strona \pageref{washizu}) -- serial
opowiadający o młodym hazardziście, który rzuca wyzwanie
\romaji{yakuzie}\footnote{\romaji{Yakuza} (ヤクザ) -- japońska mafia.}, grając z
