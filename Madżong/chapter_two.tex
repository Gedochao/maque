...
\begin{itemize}
  ...
  \begin{figure}[H]
  \centering
  \includegraphics[width=0.5\textwidth]{meld_right.jpg}
  ...
  \begin{figure}[H]
  \centering
  \includegraphics[width=0.5\textwidth]{meld_left.jpg}
  \caption{Przykład zgłoszenia \pinyin{peng} dla trójki złożonej z kamieni o
  numerze 8 z talii bambusów, przypadek dla kamienia zabranego od gracza po
  ...
  \begin{figure}[H]
  \centering
  \includegraphics[width=0.5\textwidth]{meld_mid.jpg}
  \caption{Przykład zgłoszenia \pinyin{peng} dla trójki złożonej z kamieni o
